...
const Footer = () => {
    ...
    return (
        <footer className="md:p-12 pt-12 pb-6 flex flex-col sm:flex-row justify-between font-ubuntu max-w-7xl w-4/5 mx-auto min-w-[350px]">
            ...
            <div className="mx-auto sm:mx-0 flex space-x-3 divide-x divide-gray-600 align-middle text-gray-700">
                <LogoMW className="w-8" />

                <div className="pt-1 pl-2">Made by MW</div>
            </div>

            {copySuccess && <div className="text-sm text-pink-500">{copySuccess}</div>}

            <div className="flex justify-between sm:space-x-8 text-indigo-500 font-semibold pt-1">
